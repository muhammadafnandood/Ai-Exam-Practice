        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transform transition-all">
            ...
            <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <a href="/login" className="font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-400">
                Sign in
              </a>
            </p>
          </div>
          ...
          <div className="mt-6 bg-white/10 backdrop-blur-sm rounded-xl p-4">
            <p className="text-white text-sm font-medium mb-3 text-center">Why join us?</p>
