...
export default function ChapterCard({ chapter, index }) {
  ...
  return (
    <Link href={`/exam?chapter=${chapter.chapter}&mode=main`} className="block group">
      <div className="card h-full transform transition-all duration-300 hover:scale-105">
        <div className={`w-16 h-16 bg-gradient-to-br ${colors[index]} rounded-xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform duration-300`}>
          {icons[index]}
        </div>
